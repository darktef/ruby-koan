...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is kind like recursive operation, by given a initial value, then carry 
    # out an operation on each item in the array and the result from previous operation
  end
  ...
  #   # code to read 'file'
  #   # The file in first case is actually lines
  #   # The file in second case is actually file object
  #
  # When you get to the "AboutSandwichCode" koan, recheck your answer.

  # Not pretty sure whether I understand it correctly
