...
class AboutRegularExpressions < Neo::Koan
  ...
  # Cuz it will always grab the maximum number of characters meets the requirement
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    # literally the start/end of string
  end
  ...
  def test_caret_anchors_to_the_start_of_lines
    ...
    # It seems like ^ used in range/parenthesis could represent negate?
  end
  ...
  def test_parentheses_also_capture_matched_content_by_number
    ...
    # Find two occurrence of letters
  end
  ...
  # Logicwise, they r different.
  # For character class, it will check against all characters listed, thus faster
  # For alterantion, it will check against one at a time.
  # Expand on the third reading.
  # "h\nw"[/.|\n/] => "h"
  # "h\nw"[/.\n] => "h\n"

  # Nice reading
  # - http://stackoverflow.com/questions/10691366/difference-between-abc-and-abc [Still a little bit confused]
  # - http://stackoverflow.com/questions/22132450/why-is-a-character-class-faster-than-alternation
